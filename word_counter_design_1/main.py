...
def main():
    ...
    # result_queue = "result_queue.fifo"  # For deduplication
    result_queue = "result_queue" 
    max_line_per_chunk = 1000000
            ...
            if info_message and info_message_body:
                try:
                    ...
                    print(f"Extracted parameters: bucket_name={bucket_name}, object_key={object_key}, "
                          f"max_line_per_chunk={max_line_per_chunk} , queue_size={queue_size}, wait_time={wait_time}")
                    run_ec2(ec2_name=ec2_name, max_line_per_chunk=max_line_per_chunk,queue_size=queue_size, wait_time=wait_time,
